# Create un file.txt con uno script python e testo preso da https://it.lipsum.com/ , dopo averlo fatto 
# scrivete un programma che legge il documento e ci restituisce il numero di parole, righe e caratteri.
