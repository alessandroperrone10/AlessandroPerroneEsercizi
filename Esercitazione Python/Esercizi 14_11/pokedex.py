...
class Gioco():
    ...
    def inizia_battaglia(self, pokemon1, pokemon2):
        pokedex = Pokedex()
        if pokemon1.attacco > pokemon2.difesa:
            print("Il pokemon selvatico è stato sconfitto! Catturiamolo!")
            pokedex.aggiungi_pokemon(pokemon2)
        else:
            print("Il nostro pokemon è stato sconfitto! Il selvatico è scappato!")
